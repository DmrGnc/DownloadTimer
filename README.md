...
- **Multilingual Ready:** Clean English interface for global accessibility.

## 🛠️ How to Use

1. Enter the **File Size** you wish to download.
2. Enter your **Internet Speed** manually, or click **"Check Speed"** to measure it automatically.
3. The **Estimated Time** will be calculated instantly in `HH:mm:ss` format.
...
## 🙏 Credits
- Speed measurement powered by [Speedtest by Ookla®](https://www.speedtest.net/apps/cli)
